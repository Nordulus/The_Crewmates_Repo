  ...
  for (int i = 0; i < BP32_MAX_GAMEPADS; i++) {
    GamepadPtr myGamepad = myGamepads[i];
      ...
      if (myGamepad && myGamepad->isConnected()) {
        ...
        if (buttonA == 0 && buttonB == 0 && buttonX == 0) { //laggy servo
            leftServo.write(1440);
        }
        if (dpadUp == 1){ //launcher hit
          launcher.write(1750);
          delay(1600);
          launcher.write(1500);
          dpadUp = 0;
        ...
        if (buttonY == 1){ //print QTR
          printQTR();
          Serial.println();
        }

        if (buttonA == 1){ //manual control
          //btMotorControl();
        ...
        if (buttonB == 1){ //calibrate
          calibrateQTR();
          Serial.print("printQTR for now");
          Serial.println();
          buttonB = 0;
        }
        if (buttonX == 1){ //linefollow
          PID_control();
          Serial.print("Linefollow");
          Serial.println();
        }
        if (dpadRight == 1){ //wallfollow
          wallfollower();
...
void wallfollower(){
            ...
            Serial.print("");
            Serial.print(right.getDistanceFloat());
            Serial.println();
    //int diff
    //Serial.print("right");
